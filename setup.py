...
class KytosInstall:
    ...
    def enable_core_napps():
        ...
        (ENABLED_PATH / 'mres98732').mkdir(parents=True, exist_ok=True)
        for napp in CORE_NAPPS:
            napp_path = Path('mres98732', napp)
...
class DevelopMode(develop):
    ...
    def _create_folder_symlinks():
        ...
        """
        links = INSTALLED_PATH / 'mres98732'
        ...
        (ENABLED_PATH / 'mres98732').mkdir(parents=True, exist_ok=True)
        dst = ENABLED_PATH / Path('mres98732', NAPP_NAME)
    ...
    def _create_file_symlinks():
        ...
        dst = CURRENT_DIR / 'mres98732' / '__init__.py'
        symlink_if_different(src, dst)
